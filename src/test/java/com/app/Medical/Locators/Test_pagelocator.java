...
public class Test_pagelocator {
	...
	public void Registration() {
		Reg_btn.click();
		Reg_name.sendKeys("Gaurav Mall");
		Reg_email.sendKeys("gauravmallgkp@gmail.com");
		Reg_pass.sendKeys("Saumy@26");
		Reg_btn1.click();	
	}
	public void login() {
		login_email.sendKeys("gauravmallgkp@gmail.com");
		login_pass.sendKeys("Saumy@26");
		login_btn.click();	
	}
